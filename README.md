...
Chrome history, my wiki pages, does a Bing search, and keeps a cache of blog posts, and YouTube, Vimeo and Slideshare items.
...
## Installation
- Requires [rb-appscript](http://appscript.sourceforge.net/rb-appscript/) for checking which application is running, and which page is open in Chrome
- [youtube_it](https://github.com/kylejginavan/youtube_it) and [vimeo gems](https://github.com/matthooks/vimeo) for fetching object lists
- [sqlite3](http://sqlite-ruby.rubyforge.org/sqlite3/faq.html) and [active_record](http://api.rubyonrails.org/classes/ActiveRecord/Base.html) for processing Google Chrome history database
- [curb](https://rubygems.org/gems/curb) to connect to the Bing API
...
## Usage
Use for example [Keyboard Maestro](http://www.keyboardmaestro.com/main/) to set up a shortcut, which copies the selected text to clipboard,
